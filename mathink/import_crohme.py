...
DEFAULT_SYMBOLS = {
    **{d: d for d in "0123456789"},
    ...
    # 소문자 알파벳 (l은 '1'과 모양이 같아 제외 - 필요하면 T키로 필기체 ℓ 학습)
    **{c: c for c in "cdefghijkmopqrsuvwz"},
    # 모양이 다른 대문자는 그대로 가져옴
    **{c: c for c in "ABEFGHLMNRT"},
    # 모양이 같은 대문자는 소문자 모양 클래스에 합침 (크기로 대/소 판정)
    "C": "c", "S": "s", "V": "v", "X": "x", "Y": "y", "P": "p",
    "\\times": "×", "\\div": "÷", "\\pm": "±",
